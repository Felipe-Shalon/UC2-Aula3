...
imprima no console. */
function calculoNumeros(numero1, numero2){
    const numeros = numero1 + numero2
    return numeros
}
console.log(calculoNumeros(2, 4))
...
function divisao(array){
    return novoArray = [array[array.lenght - 1] / 2, array[0] / 2]
}
